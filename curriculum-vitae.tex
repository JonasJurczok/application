...
vereinfachen soll. Das Ziel ist es das Testen verteilter Systeme zu unterstützen indem man
...
\cvitem{Beschreibung}{Theoretische Dokumentation über das Testen eines Eventsourcing Systems. Der interessante Aspekt ist, dass die Software ohne Staging system oder live Tests abgetestet werden kann. Die Grundidee ist es, die einzelnen Services transitiv über Contracts zu testen und damit einen kompletten use case abbilden zu können. Das Projekt enthält auch eine Referenzimplementation in \textsc{Java} mit \textsc{Spring-Boot}}
