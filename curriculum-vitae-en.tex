...
\cventry{06/2025 -- today}{System responsible DataOperations}{}{\textsc{S-Kreditpartner GmbH}}{Berlin}{\begin{itemize}
\item Responsible for operations of all applications in the BI department
\item Responsible for the development and implementation of department wide system architectures
\item Responsible for developing and implementing processes to establish a professional operations environment
\item Creation of a leadership team for the DataOps team
\item Training the entire department in aspects of software engineering (testing, CI/CD, ...)
\end{itemize}}

\cventry{06/2021 -- 05/2025}{Teamlead Robotics}{}{\textsc{Gropyus Technology GmbH}}{Berlin}{\begin{itemize}
\item Responsible for programming a machine orchestration system for automated manufacturing
\item Development of team processes and best practices
\item Creation of a CI/CD solution for Beckhoff PLCs
\item Hiring and performance management
\item Development of a future oriented software architecture
\end{itemize}}

\cventry{03/2020 -- 05/2021}{Senior Software Engineer}{}{\textsc{Gropyus Technology GmbH}}{Berlin}{\begin{itemize}
\item Responsible for conception and implementation of the GROPYUS MES system
\item Coordination between process planners and robotics engineers
\item Implementation of a BPMN based solution to orchestrate an automated manufacturing plant
\item Building a team from scratch to 6 engineers
\end{itemize}}


\cventry{06/2018 -- 02/2020}{Privacy Architect}{}{\textsc{Akelius GmbH}}{Berlin}{\begin{itemize}
\item responsible for the GDPR compliance of the Technology department
\item developing technical solutions to support the engineers with being compliant
\item coordinating with legal and DPO to develop compliant solutions
\item project responsible for a compliant solution for rights and permission mangement
\item supporting devops in developing a compliant IT platform based on Kubernetes and Azure
\item developing and running processes for access requests and incidents
\item training of all german employees in GDPR basics
\end{itemize}}

\cventry{04/2018 -- 06/2018}{Tech Lead (Teamlead)}{}{\textsc{Akelius GmbH}}{Berlin}{\begin{itemize}
\item bootstrapping a mobile development team for the Akelius language school charity project
\item setting up team processes
\item developing implementation strategy for the android application
\item coordinating development best practices between iOS and android subteams
\item responsible for hiring engineers and a teamlead
\end{itemize}}
...
\subsection{Akelius identity governance}
\cvitem{Type}{company infrastructure project}
\cvitem{Time}{03/2019 -- Today}
\cvitem{Team}{Akelius IAM Team, DPO}
\cvitem{Description}{The goal is to develop a self service solution for all of Akelius to manage roles and permissions.
The idea is to separate technical and functional roles with the goal of distributing the responsibilities to the best informed people. Also compliance requirements like audits, approvals and criticality classifications have to be fulfilled. Currently the concept is finished, the communication to the company just started.}

\vspace{10pt}

\subsection{Akelius devops platform}
\cvitem{Type}{Development infrastructure project}
\cvitem{Time}{06/2018 -- Today}
\cvitem{Team}{Akelius DevOps Team, Legal, DPO}
\cvitem{Technologies}{\textsc{Azure}, \textsc{Kubernetes}}
\cvitem{Description}{Create a controlled environment for engineers to deploy and run their applications.
The platform should provide code repositories, development workflows (PRs, code reviews), CI/CD and a scalable cloudbased infrastructure for life and testing stages. All access to secrets, data stores and other entities must be GDPR compliant and secure.}

\vspace{10pt}

\subsection{Stock Component}
\cvitem{Type}{Development project}
\cvitem{Time}{03/2017 -- 03/2018}
